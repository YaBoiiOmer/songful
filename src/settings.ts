...
//   console.log("Expecting to downlad", playlist.tracks.items.length, "songs");
...
//       try {
//         const result = await downloadSong(video.url);
//         if (!result.success) {
...
//   console.log("Downloaded", filteredSongs.length, "songs");
